...
### Avaleht
![Avaleht](app/screenshots/01_avaleht.png)

### Broneeringute nimekiri (Admin)
![Broneeringud](app/screenshots/02_broneeringud.png)

### Uue broneeringu lisamine
![Uus broneering](app/screenshots/03_uus_broneering.png)

### Broneeringu muutmine
![Muuda broneeringut](app/screenshots/04_muuda_broneering.png)

### Arvutiklassid
![Klassid](app/screenshots/05_klassid.png)

### Kasutajad ja grupid
![Kasutajad](app/screenshots/06_kasutajad.png)

### Statistikavaade
![Statistika](app/screenshots/07_statistika.png)

### Vaataja roll (nupud peidetud)
![Viewer](app/screenshots/08_viewer_broneeringud.png)
